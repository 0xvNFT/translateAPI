package com.dichthuatjun88binh.jun88.service;
...
import com.dichthuatjun88binh.jun88.activites.ActivitySplash;
import com.dichthuatjun88binh.jun88.activites.HomeActivity;

import java.util.List;

public class FloatingWidgetService extends Service implements View.OnClickListener {
    public static final String ACTION_START = "com.dichthuatjun88binh.jun88.service.FloatingWidgetService.ACTION_START";
    public static final String ACTION_CAPTURE_DONE = "com.dichthuatjun88binh.jun88.service.FloatingWidgetService.ACTION_CAPTURE_DONE";
    private WindowManager mWindowManager;
    private View mFloatingWidgetView, collapsedView, expandedView, half_icon, rootContainer;
    ...
    public void onCreate() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            String CHANNEL_ID = "translate_widget";
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID,
                    "Translate Language", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            switch (action) {
                ...
                case ACTION_CAPTURE_DONE:
                    collapsedView.setVisibility(View.GONE);
                    expandedView.setVisibility(View.GONE);
                    half_icon.setVisibility(View.VISIBLE);
                    break;
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        half_icon = mFloatingWidgetView.findViewById(R.id.half_icon);
        rootContainer = mFloatingWidgetView.findViewById(R.id.root_container);
...
//                        handler_longClick.removeCallbacks(runnable_longClick);
    ...
    private void implementClickListeners() {
        ...
        mFloatingWidgetView.findViewById(R.id.openApp).setOnClickListener(this);
        mFloatingWidgetView.findViewById(R.id.translateScreenshot).setOnClickListener(this);
        mFloatingWidgetView.findViewById(R.id.half_icon).setOnClickListener(this);
    }
...
//                stopSelf();
            ...
            case R.id.half_icon:
                ...
                half_icon.setVisibility(View.GONE);
                break;
            case R.id.openApp:
                moveToLeft(szWindow.x);
                collapsedView.setVisibility(View.GONE);
                ...
                if (isAppRunning(this, getPackageName())) {
                    ...
                    this.getApplicationContext().startActivity(new Intent(FloatingWidgetService.this, ActivitySplash.class));
                }
